...
const controlRecipes = async function() {
    try {
        ...
        // 2) Loading recept
        await _modelJs.loadRecipe(id); //loadRecipe vraća promise zato moramo taj promise hendlati. Ovdje jedna async func zove drugu async funk
        // 3) Rendering recept
...
const init = function() {
    _bookmarksViewJsDefault.default.addHendlerRender(controlBookmarks);
...
const createRecipeObject = function(data) {
    const { recipe  } = data.data; //destructuring object (ako je isto ime ne treba ga stavljati iza točke.zadnje)
    return {
        //new object
        id: recipe.id,
        title: recipe.title,
...
const updateServings = function(newServings) {
    ...
    //newQt = oldQt * newServings / oldServings // 2 * 6 / 4 = 3
...
const KEY = '37ad0266-c018-472a-871e-b49f2f199e11';
...
},{"regenerator-runtime":"1EBPE","../js/config.js":"6V52N","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1EBPE":[function(require,module,exports) {
/**
...
class RecipeView extends _viewJsDefault.default {
    ...
    _generateMarkupIngredient(ing) {
        ...
        <div class="recipe__quantity">${ing.quantity ? new _fractionalJsDefault.default(ing.quantity).toString() : ''}</div>
...
},{"./View.js":"9dvKv","url:../../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","../fractional.js":"GCAiO"}],"9dvKv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
   ...
   * @author Perica Bartulović inspired by Jonas Schmedtmann
   * @todo Finish implementation
   */ render(data, render = true) {
        if (!data || Array.isArray(data) && data.length === 0) return this.renderError();
        this._data = data;
        const markup = this._generateMarkup();
        if (!render) return markup; // ovaj guard clause osigurava da se prekine funkcija i da se samo vrati markup što je u slučaju PreviewView.render jedino potrebno. U slučaju BookmarksView.render parametar render je po defaultu true pa se nastavlja izvedba i stvoreni markup se učita u DOM.
        this._clear();
...
},{}],"GCAiO":[function(require,module,exports) {
...
Fraction.primeFactors = function(n) {
    ...
    if (num != 1) // ...this must be the last prime factor
...
class ResultView extends _viewJsDefault.default {
    ...
    _errorMessage = `No recipes foung for your query! Please try again ;)`;
    _message = '';
    _generateMarkup() {
...
class PreviewView extends _viewJsDefault.default {
    // ova klasa je kao neki child view za bookmarksView i resultsView i generira markup za njih
    _parentElement = '';
    _generateMarkup() {
        const id = window.location.hash.slice(1);
        return `
...
class BookmarksView extends _viewJsDefault.default {
    ...
    _generateMarkup() {
        ...
        ) //false osigurava da ova metoda vrati string a ne da nešto renderira u DOM
        .join('');
    }
}
